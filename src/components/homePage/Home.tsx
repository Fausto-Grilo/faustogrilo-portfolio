        ...
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                ...
                <p className="text-grey-400 text-lg mb-8 max-w-lg mx-auto">
                    I'm a passionate software engineer with a love for creating innovative solutions. I specialize in web development, and I'm always eager to learn new technologies and improve my skills.
                </p>
